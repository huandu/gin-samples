$(function() {
	...
	var GAME_CANVAS_WIDTH = 800;
	var GAME_CANVAS_HEIGHT = 400;
	var GAME_CANVAS_BORDER = 10;
	
	var GAME_SHAPE_RADIUS = 100;
	var GAME_SHAPE_RADIUS_DELTA = .5;
	var GAME_SHAPE_LINE_WIDTH = 2;
	var GAME_SHAPE_SHADOW_BLUR = 10;
	var GAME_SHAPE_MOVEMENT = 10;
	var GAME_SHAPE_MOVEMENT_DELTA = 6;
	var GAME_SHAPE_SPIN = 0.04;
	var GAME_SHAPE_SPIN_DELTA = 0.01;
	var GAME_FRAGMENT_RADIUS = 40;
	
	var GAME_MOUSETRACER_LINE_WIDTH = 4;
	var GAME_MOUSETRACER_DOT_AGE = 7;
	var GAME_MOUSETRACER_EVENT_AGE = 7;
	var GAME_MOUSETRACER_AGE_DIFF = GAME_MOUSETRACER_DOT_AGE - GAME_MOUSETRACER_EVENT_AGE;
	var GAME_MOUSETRACER_SHADOW_BLUR = 20;
    
    var GAME_FADE_DURANCE = 800;
